...
class ClientListFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        view.findViewById<Button>(R.id.add_cliente).setOnClickListener {
            findNavController().navigate(R.id.action_clientListFragment_to_addClientFragment)
        }
        Thread {
            ...
            activity?.runOnUiThread {
                recyclerView = view.findViewById(R.id.client_recyclerView)
